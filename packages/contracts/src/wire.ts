...
export const providerCapabilities = ['lease.fencing.v1', 'ax.read.v1', 'ax.find.v1', 'input.named-keys.v1', 'scroll.dom.v1', 'ax.checked-state.v1', 'input.wheel.v1', 'input.radio.v1', 'ax.editable-state.v1', 'ax.page.v1', 'frame.sessions.v1', 'ax.frame.v1', 'input.frame-click.v1', 'ax.frame-find.v1', 'ax.frame-subtree.v1', 'ax.frame-page.v1', 'ax.frame-text.v1'] as const;
export const brokerCapabilities = ['runtime.v1', 'observe.query.v1', 'journal.recovery.v1', 'provider.ax-read.v1', 'provider.ax-find.v1', 'runtime.check.v1', 'runtime.wheel.v1', 'runtime.radio.v1', 'runtime.capture-publication.v1', 'runtime.contenteditable-fill.v1', 'runtime.append.v1', 'runtime.element-state.v1', 'runtime.batch.v1', 'runtime.page.v1', 'runtime.frames.v1', 'observe.frame.v1', 'runtime.frame-click.v1', 'observe.frame-query.v1', 'observe.frame-subtree.v1', 'observe.frame-page.v1'] as const;
export const clientRequirements = ['runtime.v1', 'observe.query.v1', 'journal.recovery.v1', 'runtime.check.v1', 'runtime.wheel.v1', 'runtime.radio.v1', 'runtime.capture-publication.v1', 'runtime.contenteditable-fill.v1', 'runtime.append.v1', 'runtime.element-state.v1', 'runtime.batch.v1', 'runtime.page.v1', 'runtime.frames.v1', 'observe.frame.v1', 'runtime.frame-click.v1', 'observe.frame-query.v1', 'observe.frame-subtree.v1', 'observe.frame-page.v1'] as const;
